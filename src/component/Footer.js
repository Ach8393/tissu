...
<footer className="pa4 pa5-l black-70 bt b--black-10">
  ...
  <section className="cf mb5">
    ...
    <div className="mb4 mb0-ns fl w-100 w-50-l" >
      ...
      <input placeholder="Email Address" classNameName="mw-100 w-100 w5-ns f5 input-reset ba b--black-20 pv3 ph4 border-box" />
      <input type="submit" classNameName="input-reset w-100 w-auto-ns bg-black-80 white f5 pv2 pv3-ns ph4 ba b--black-80 bg-hover-mid-gray" />
    </div>
  </section>
